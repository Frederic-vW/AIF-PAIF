...
def aif(x, ns, kmax):
    ...
    for k in range(kmax):
        ...
        a[k] = h1 + h2 - h12
        if (k%10 == 0): print("\tAIF(k={:d})".format(k))
...
def plot_xkcd_aif_paif(x, ns, kmax):
    """
...
def main():
    ...
    f_gm2 = "./datagm2.npy"
    f_gm7 = "./datagm7.npy"
    f_Ising1 = "./dataIsing2D_L50_N1000000_Temp2.27.npy"
    f_Ising2 = "./dataIsing2D_L50_N1000000_Temp5.00.npy"
    f_ch = "./datach.npy"
    f_ms = "./dataeeg_ms.npy"
